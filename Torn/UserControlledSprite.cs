...
namespace Torn
{
    ...
    class UserControlledSprite : Sprite
    {
        ...
        bool update, moving, isArms, isLegs, isVisible, pulling;
        char direction;
        int steps;
        int obstacleIndex;
        ...
        //Method to save the data about the sprite
        public UserControlledSpriteSave SaveSprite()
        {
            UserControlledSpriteSave spriteSave = new UserControlledSpriteSave(textureFile, position, center, color);
            return spriteSave;
        }

        //Method to load the data about the sprite
        public void LoadSprite(UserControlledSpriteSave spriteSave)
        {
