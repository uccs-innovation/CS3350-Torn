...
namespace Torn
{
    ...
    class AnimatedSprite : Sprite
    {
        ...
        public AnimatedSpriteSave SaveSprite()
        {
            AnimatedSpriteSave spriteSave = new AnimatedSpriteSave(textureFile, position, center, color, directionX, directionY);
            return spriteSave;
        }

        public void LoadSprite(AnimatedSpriteSave spriteSave)
        {
            textureFile = spriteSave.textureFile;
            position = spriteSave.position;
            center = spriteSave.center;
            color = spriteSave.color;
            directionX = spriteSave.directionX;
            directionY = spriteSave.directionY; ;
        }
    }
}
